# Определяем словарь с очками для каждой буквы
...
# Запрашиваем у пользователя слово и переводим все буквы в верхний регистр
...
for letter in word:
    if letter in scores_eng:
        ...
        total_score += scores_rus[letter]

# Выводим итоговую сумму очков
print(f"Слово '{word}' приносит {total_score} очков")
